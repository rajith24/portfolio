        ...
        <div className='main-container'>
            <svg width="300" height="300" data-name="corner-top-left" xmlns="http://www.w3.org/2000/svg" style={{ pointerEvents: "none" }} data-inlinesvg=".inlineSvgFile-6">
                    <defs><linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0" stop-color="rgb(192,86,123)" className="gradient1"></stop>
                        <stop offset=".5" stop-color="rgb(178,134,86)" className="gradient2"></stop>
                        <stop offset="1" stop-color="rgb(192,86,123)" className="gradient1"></stop>
                    </linearGradient>
                    </defs>
                ...
                <main className="projects-overview">
                    <div className="main-message"> <div className="welcome-message"> <div id="welcome">
                        <svg id="welcome_svg" xmlns="http://www.w3.org/2000/svg" width="605.44" height="122.24" viewBox="0 0 1892 382" data-inlinesvg=".inlineSvgFile-7">
                            <path id="welcome_path" style={{ strokeDasharray: "9541.93, 9541.93", strokeDashoffset: "7156", transition: "fill 1s ease-in-out 0s", stroke: "rgb(204, 204, 204)", fill: "rgb(204, 204, 204)" }}
                                stroke="none" stroke-miterlimit="10" stroke-width="2"
                        ...
                        <span style={{color: 'antiquewhite'}}> <p>My name is Rajith, I'm a front-end developer based in Stuttgart, Germany. I have developed many types of front-ends from well know DJ applications to Ecommerce booking platforms.</p>
                            <p>I'm passionate about cutting-edge, pixel-perfect, beautiful interfaces and intuitively implemented UX. </p> </span> </div>
